...
export default function RegisterPage() {
  ...
  return (
    <div className="mx-auto grid min-h-[calc(100vh-88px)] max-w-7xl items-center gap-10 px-6 py-12 lg:grid-cols-2">
      <div>
        <p className="text-sm uppercase tracking-[0.3em] text-emerald-700">Registro</p>
        <h1 className="mt-4 text-5xl font-semibold leading-tight">
          Crea una cuenta para reservar alojamientos del camping.
        </h1>
        <p className="mt-6 max-w-xl text-lg text-stone-600">
          Base preparada para integrar el alta de usuarios con `POST /api/auth/register`.
        </p>
      </div>
      ...
      >
        ...
        <button
          ...
          className="mt-8 w-full rounded-full bg-emerald-600 px-5 py-3 text-sm font-medium text-white transition hover:bg-emerald-500 disabled:cursor-not-allowed disabled:bg-emerald-300"
        >
